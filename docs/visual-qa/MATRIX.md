...
| 组件 | 状态 / 场景 | Figma 参考（canonical） | Path A 结果 | 偏差说明 | Path B（HTML） |
|------|-------------|------------------------|-------------|----------|----------------|
| Alert | info + close | 见 [COMPONENT-FIGMA-LINKS](./COMPONENT-FIGMA-LINKS.md) | | | `.design-spec/demos/components/alert.html` |
| Button | default / hover / disabled | 同上 | | | `.design-spec/demos/components/button.html` |
