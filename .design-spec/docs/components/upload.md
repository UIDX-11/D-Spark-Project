...
- Arco Vue（API / 行为真源）: [https://arco.design/vue/component/upload](https://arco.design/vue/component/upload)
- Arco 源码: `arco-design-vue/packages/web-vue/components/upload/`
- Figma（Light，视觉真源）: [D.S. Web Com — Light](https://www.figma.com/design/KJfy0GFDs8kLsXTzhTxAjd/D.S-Web-Com_Light_V2_2026) — 请在文件中定位 **Upload** 画板，将本行替换为带 `node-id=` 的深链接。
