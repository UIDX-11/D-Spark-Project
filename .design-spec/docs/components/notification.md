...
- Arco Vue（API / 行为真源）: [https://arco.design/vue/component/notification](https://arco.design/vue/component/notification)
- Arco 源码: `arco-design-vue/packages/web-vue/components/notification/`
