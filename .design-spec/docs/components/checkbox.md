...
- Figma（Light，真源表 canonical / `figma_truth_table.json`）: [Primary node](https://www.figma.com/design/KJfy0GFDs8kLsXTzhTxAjd/D.S-Web-Com_Light_V2_2026?node-id=116449-133503)
- Arco Design Web React（API / 行为真源）: [https://arco.design/react/components/checkbox](https://arco.design/react/components/checkbox)
- Arco 源码（React）: [`arco-design/components/Checkbox`](https://github.com/arco-design/arco-design/tree/main/components/Checkbox)
