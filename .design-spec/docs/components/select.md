...
- Arco Vue（API / 行为真源）: [https://arco.design/vue/component/select](https://arco.design/vue/component/select)
- Arco 源码: `arco-design-vue/packages/web-vue/components/select/`
